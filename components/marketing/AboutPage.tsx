          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                tag: 'SECURE',
                title: 'Vault Storage',
                desc: 'Segregated, insured vault storage for your precious metals. Your metals, your bag, your bin. Digital access through Maroon. Value-based pricing from 0.50% annually.',
                icon: (
                  <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
